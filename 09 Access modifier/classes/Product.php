...
class Product {
	...
	// есть вероятность случайно переопределить свойство из вне класса - это нам не надо. Поэтому предоставлять доступ к скидке таким образом - public $discount = 10; - не правильно. Делаем так:
	private $discount = 0;
	...
	*/
	...
	/*
	Именно через гетторы и сетторы мы получаем дотуп к private и protected свойствам.
